...
import com.mediplus.spapp.domain.model.VerificationAttempt
import org.junit.Assert.assertTrue
import org.junit.Test

/**
 * T059 — audit/outcome records carry metadata only and never raw biometrics (FR-017, FR-030). The
 * types that represent recorded outcomes (sign-in/member/face/enrollment) must not declare any
