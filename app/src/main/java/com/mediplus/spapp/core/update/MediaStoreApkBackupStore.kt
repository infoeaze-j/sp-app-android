...
/**
 * The real [ApkBackupStore]: `Downloads/SpApp/` via MediaStore on API 29+, the public
...
class MediaStoreApkBackupStore @Inject constructor(
    ...
    private companion object {
        ...
        val RELATIVE_DIR = "${Environment.DIRECTORY_DOWNLOADS}/SpApp/"
        const val LEGACY_SUBDIR = "SpApp"
