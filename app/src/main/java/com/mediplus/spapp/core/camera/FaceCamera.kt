 ...
 * [com.mediplus.spapp.core.nfc.MemberCardReader] gives the NFC path.
 *
 ...
 *
 * A factory rather than a switching decorator (unlike [com.mediplus.spapp.core.nfc.MemberCardReader]):
 ...
 * directly rather than having it injected into [com.mediplus.spapp.ui.facecheck.FaceCheckViewModel].
 */
@EntryPoint
