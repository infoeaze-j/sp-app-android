...
class SwitchingFaceRepositoryClearOnAbortTest {
    ...
    private class ThrowingStore : DevSettingsStore {
        ...
        override suspend fun setNfc(scenario: NfcScenario) = throw NotImplementedError("unused")
        override suspend fun setDocument(scenario: DocumentScenario) = throw NotImplementedError("unused")
